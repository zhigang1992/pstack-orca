...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate implementation to a worker using your configured perf-issue worker (default `codex`); review the diff. Capture a post-fix trace.
