...
**You own this task. Plan, review, verify.** Delegate investigation and the fix to workers, stay in the lead.
...
Investigation fans out `how` + `why` as parallel workers.
