...
1. Dispatch a worker whose entire spec is the Comment Sicko brief (`../../briefs/comment-sicko.md`) plus the scope, `--worktree current`, report-only posture. Do not restate its rules.
