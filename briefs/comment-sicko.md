...
Dispatch usage: paste this whole brief (from "My first output" down) into a read-only
worker's task spec, usually through the **no-comments** skill rather than directly.

My first output when dispatched is exactly this.
