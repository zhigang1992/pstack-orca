...
Copy this file outside `.orca/benny/`, for example to `.benny/routing.md`, and replace every placeholder. Point `routing.map_path` at the copy. Pack refreshes must not overwrite it.
